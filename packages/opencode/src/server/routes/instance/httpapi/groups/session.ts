...
import { ApiNotFoundError, PermissionNotFoundError, SessionBusyError, SessionTeleportedError } from "../errors"
    ...
    HttpApiGroup.make("session")
      .add(
        ...
        HttpApiEndpoint.post("prompt", SessionPaths.prompt, {
          ...
          error: [HttpApiError.BadRequest, ApiNotFoundError, SessionTeleportedError],
        }).annotateMerge(
          OpenApi.annotations({
        ...
        HttpApiEndpoint.post("shell", SessionPaths.shell, {
          ...
          success: described(SessionV1.WithParts, "Created message"),
          error: [HttpApiError.BadRequest, ApiNotFoundError, SessionBusyError, SessionTeleportedError],
        }).annotateMerge(
          OpenApi.annotations({
